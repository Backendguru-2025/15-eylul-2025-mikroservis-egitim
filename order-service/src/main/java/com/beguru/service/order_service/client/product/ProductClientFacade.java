...
public class ProductClientFacade {
    ...
    private ProductResponse fallbackRuntimeException(Long productId, ResourceAccessException resourceAccessException) {
        System.out.println("Circuit breaker fallback activated for productId: " + productId);
        System.out.println("Fallback ResourceAccessException :"+ resourceAccessException);
        return new ProductResponse(-1,"dummy-product", "lorem ipsum", BigDecimal.ONE.negate());
    }
}
